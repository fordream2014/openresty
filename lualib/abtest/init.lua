...
local strategy_file = "/data/www/openresty/lualib/abtest/conf/strategy.json"
local upstream_file = "/data/www/openresty/lualib/abtest/conf/upstream.json"
...
if status then
    ...
    --log(ERR, "strategy: ", strategy_config['100020']['key'])
...
if init_status then
    ...
    --log(ERR, "upstream config: ", upstream_config["user_upstream"]["method"])
